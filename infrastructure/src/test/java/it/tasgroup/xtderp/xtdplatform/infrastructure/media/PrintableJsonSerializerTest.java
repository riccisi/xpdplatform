        ...
        Printable printable = new Printable() {
            ...
            public <T> Rendered<T> print(Media<T> media) {
                return media.object()
                    ...
                    .with("prop5", true)
                    .with("prop6", date);
                    // @todo #1 add overloaded methods for collection of primitives
                    //.with("prop7", new PrintableCollection(Arrays.asList("1","2"), s -> ));
            }
        };

        assertThat(tester.test(printable), is(equalTo("{\"prop1\":\"val1\",\"prop2\":1,\"prop3\":1,\"prop4\":1.2,\"prop5\":true,\"prop6\":\"2018-02-16T00:00:00.000+0100\"}")));
    }
}