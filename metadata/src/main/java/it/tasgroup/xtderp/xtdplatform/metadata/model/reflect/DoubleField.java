...
public final class DoubleField implements Field {
    ...
    private <T> double getValue(T entity) throws IllegalAccessException {
        return this.field.getType().isPrimitive() ? this.field.getDouble(entity) : (Double) this.field.get(entity);
    }
