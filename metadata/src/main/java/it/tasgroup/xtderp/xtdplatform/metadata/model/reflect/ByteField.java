...
public final class ByteField implements Field {
    ...
    private <T> byte getValue(T entity) throws IllegalAccessException {
        return this.field.getType().isPrimitive() ? this.field.getByte(entity) : (Byte) this.field.get(entity);
    }
