...
public final class IntField implements Field {
    ...
    private <T> int getValue(T entity) throws IllegalAccessException {
        return this.field.getType().isPrimitive() ? this.field.getInt(entity) : (Integer) this.field.get(entity);
    }
