...
@EqualsAndHashCode
public final class LongField implements Field {
    ...
    private <T> long getValue(T entity) throws IllegalAccessException {
        return this.field.getType().isPrimitive() ? this.field.getLong(entity) : (Long) this.field.get(entity);
    }
