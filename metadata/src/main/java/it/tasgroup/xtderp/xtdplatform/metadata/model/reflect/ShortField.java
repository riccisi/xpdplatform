...
public final class ShortField implements Field {
    ...
    private <T> short getValue(T entity) throws IllegalAccessException {
        return this.field.getType().isPrimitive() ? this.field.getShort(entity) : (Short) this.field.get(entity);
    }
