...
public final class BigIntegerField implements Field {
    ...
    private <T> BigInteger getValue(T entity) throws IllegalAccessException {
        return (BigInteger) this.field.get(entity);
    }
